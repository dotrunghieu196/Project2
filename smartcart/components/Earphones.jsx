...
const Earphones = () => {
    ...
    <div className="flex flex-col w-full p-4 gap-4 bg-white rounded-xl shadow-md">
        <div className="flex items-center justify-between w-full pt-2">
            <span className="text-3xl text-black font-bold">Tai nghe</span>
            <div className="flex items-center w-fit h-10 p-2 gap-2 bg-white border border-gray-200 hover:border-[#0033CC] text-gray-400 hover:text-[#0033CC] rounded-full shadow-md cursor-pointer">
